...
cd %build_dir%
qmake %tools_dir%..\Library\UniversalTsnAnalyzer\UniversalTsnAnalyzer_static.pro
...
xcopy /y %build_dir%\release\UniversalTsnAnalyzer.exe                                  %binary_dir%\
